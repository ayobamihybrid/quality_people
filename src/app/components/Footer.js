...
const Footer = ({ contactUs }) => {
  return (
    <div
      className={`w-full bg-[#2c3f50] flex flex-col md:flex-row justify-between items-center gap-14 md:gap-0 p-4 ${
        contactUs && 'rounded-t-[2rem] xl:rounded-t-[5rem] py-12 xl:py-32 px-20'
      } `}
    >
