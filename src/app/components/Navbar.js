...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 xl:top-9 z-50 max-w-[1440px] mx-auto w-full py-3 px-4 bg-[#E6F1F1] md:p-4 rounded-md shadow-lg flex justify-between items-center">
      <div className="flex items-center gap-1">
        <svg
          viewBox="0 0 29 32"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="w-[1.6rem] h-[1.8rem] xl:w-[2.5rem] xl:h-[3rem]"
        >
        ...
        <div
          className="text-[#F99B2A] font-bold text-xs md:text-sm xl:text-xl cursor-pointer"
